...
insert into users values ('u001','Vince Wain','blaH','Edmonton', '2019-01-05');
insert into users values ('u002','George', 'password','Regina', '2019-01-06');
insert into users values ('u003','Martha','omanz', 'Toronto', '2019-01-10');
insert into users values ('u004','Donald Comb','hate291', 'Edmonton', '2019-01-15');
insert into users values ('u005','Jane Doe','lanaxox', 'Regina', '2019-02-03'); 
insert into users values ('u006','John Doe','ugH762', 'Regina', '2019-02-03');
insert into users values ('u007','Mark Burger','blaH352', 'Toronto', '2019-03-04');
insert into users values ('u008','Stevey Manny','no_stoP', 'Calgary', '2019-03-05');
insert into users values ('u009','Barney Barns', 'lame','Calgary', '2019-03-06');
insert into users values ('u010','Jane Doe','toomuch_worK','Ottawa', '2019-03-08');
insert into users values ('u011','Lily Ford','lil6532', 'Regina', '2019-06-03'); 
insert into users values ('u012','Joe Butters','breaDbutter', 'Regina', '2019-06-03');
insert into users values ('u013','Henry', 'cavill?','Toronto', '2019-06-04');
insert into users values ('u014','Stanley','ka_dabba?', 'Calgary', '2019-06-05');
insert into users values ('u015','Riley', 'fromstaTs?', 'Toronto', '2019-06-06');
insert into users values ('u016','Haley', 'dunphy?','Ottawa', '2019-06-08');
insert into users values ('u017','Inactive Man','ithinkimCool','Edmonton','2019-06-09');
insert into users values ('u018','Joe Schmo','someWeirdLastname','Mumbai','2019-06-10');
...
insert into privileged values('u004');
insert into privileged values('u0012');
insert into privileged values('u008');
insert into privileged values('u0010');
insert into privileged values('u0015');
insert into privileged values('u001');
insert into privileged values('u0017');